"""Action handler seed for purchase_requisition:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'approved', 'converted', 'cancelled'], 'transitions_to': 'archived'}
