"""Action handler seed for purchase_requisition:submit."""
...
ACTION_ID = "submit"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'approved', 'converted', 'cancelled'], 'transitions_to': 'submitted'}
