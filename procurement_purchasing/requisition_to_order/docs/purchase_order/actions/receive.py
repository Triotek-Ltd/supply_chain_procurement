"""Action handler seed for purchase_order:receive."""
...
ACTION_ID = "receive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'partially_received', 'received', 'billed'], 'transitions_to': None}
...
def handle_receive(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
