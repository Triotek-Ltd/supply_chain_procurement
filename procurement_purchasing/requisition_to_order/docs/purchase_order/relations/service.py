"""Relation service seed for purchase_order."""
...
RELATED_DOCS = [{'doc_id': 'purchase_requisition', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'goods_receipt', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'supplier_invoice', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'supplier_profile', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'supplier'}, {'description': 'request details from supplier_profile'}, {'description': 'purchase_requisition'}]
