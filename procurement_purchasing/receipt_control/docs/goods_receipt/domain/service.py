"""Business-domain service seed for Goods Receipt."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['draft', 'submitted', 'completed', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'supplier': 'party_reference', 'receipt_date': 'schedule_marker', 'warehouse': 'relation_reference', 'receipt_status': 'status_flag', 'related_purchase_order': 'relation_collection', 'related_stock_item': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'receipt_code', 'supplier', 'receipt_date'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'submitted', 'completed', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'review': None, 'submit': 'submitted', 'accept': None, 'reject': None, 'close': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['warehouse execution feeds shipment, fulfillment, replenishment, and inventory accuracy'], 'related_docs': ['purchase_order', 'supplier_invoice', 'warehouse_record', 'stock_item'], 'action_targets': {'create': None, 'review': None, 'submit': 'submitted', 'accept': None, 'reject': None, 'close': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
