"""Action handler seed for stock_adjustment:apply."""
...
ACTION_ID = "apply"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['open', 'reviewed', 'approved', 'applied'], 'transitions_to': None}
...
def handle_apply(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
