"""Relation service seed for stock_adjustment."""
...
RELATED_DOCS = [{'doc_id': 'inventory_balance', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'inventory_movement', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'warehouse_record', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'balance'}, {'description': 'location context from linked docs'}]
