"""Relation service seed for inventory_movement."""
...
RELATED_DOCS = [{'doc_id': 'stock_item', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'warehouse_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'goods_receipt', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'shipment_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'stock_adjustment', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'item'}, {'description': 'location context from linked masters'}]
