"""Action handler seed for transport_booking:submit."""
...
ACTION_ID = "submit"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'confirmed', 'cancelled'], 'transitions_to': 'submitted'}
