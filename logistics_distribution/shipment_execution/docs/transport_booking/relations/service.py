"""Relation service seed for transport_booking."""
...
RELATED_DOCS = [{'doc_id': 'shipment_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'freight_booking', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'courier_shipment_request', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'shipment dimensions'}, {'description': 'routing context from shipment_record'}]
