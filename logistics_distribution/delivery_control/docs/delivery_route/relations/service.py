"""Relation service seed for delivery_route."""
...
RELATED_DOCS = [{'doc_id': 'shipment_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'delivery_confirmation', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'shipment'}, {'description': 'destination details from shipment_record'}]
