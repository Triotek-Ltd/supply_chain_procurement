"""Business-domain service seed for Delivery Confirmation."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'delivery_date': 'schedule_marker', 'related_delivery_route': 'relation_collection', 'related_courier_tracking_event': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'confirmation_code', 'shipment', 'delivery_date'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'review': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['delivery completion feeds billing, customer service, and performance reporting'], 'related_docs': ['shipment_record', 'delivery_route', 'courier_tracking_event'], 'action_targets': {'record': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
