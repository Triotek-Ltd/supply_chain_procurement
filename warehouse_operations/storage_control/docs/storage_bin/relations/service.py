"""Relation service seed for storage_bin."""
...
DOC_ID = "storage_bin"
RELATED_DOCS = [{'doc_id': 'warehouse_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'inventory_balance', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'pick_list', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'putaway_task', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'warehouse identity from warehouse_record'}]
