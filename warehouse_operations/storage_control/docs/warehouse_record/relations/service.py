"""Relation service seed for warehouse_record."""
...
RELATED_DOCS = [{'doc_id': 'storage_bin', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'goods_receipt', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'inventory_balance', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'pick_list', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'putaway_task', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'location/site metadata from facilities or org docs where applicable'}]
