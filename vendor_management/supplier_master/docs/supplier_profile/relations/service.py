"""Relation service seed for supplier_profile."""
...
RELATED_DOCS = [{'doc_id': 'supplier_qualification', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'vendor_contract', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'vendor_review', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'purchase_order', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'external compliance/capability context from ecosystem supplier docs where linked'}]
