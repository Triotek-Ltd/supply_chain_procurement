...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'supplier': 'party_reference'}, 'search_fields': ['title', 'reference_no', 'description', 'qualification_code', 'supplier', 'checklist'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'in_review', 'qualified', 'rejected', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'review': 'in_review', 'approve': None, 'reject': 'rejected', 'close': 'closed', 'archive': 'archived'}}
