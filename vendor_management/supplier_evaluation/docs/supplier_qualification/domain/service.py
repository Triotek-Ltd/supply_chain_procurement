"""Business-domain service seed for Supplier Qualification."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['opened', 'in_review', 'qualified', 'rejected', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'supplier': 'party_reference', 'related_vendor_review': 'relation_collection', 'related_vendor_contract': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'qualification_code', 'supplier', 'checklist'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'in_review', 'qualified', 'rejected', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'review': 'in_review', 'approve': None, 'reject': 'rejected', 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['supplier_profile', 'vendor_review', 'vendor_contract'], 'action_targets': {'create': None, 'review': 'in_review', 'approve': None, 'reject': 'rejected', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
