"""Relation service seed for supplier_qualification."""
...
RELATED_DOCS = [{'doc_id': 'supplier_profile', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'vendor_review', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'vendor_contract', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'supplier identity from supplier_profile'}]
