"""Action handler seed for supplier_qualification:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'qualified', 'rejected'], 'transitions_to': 'archived'}
