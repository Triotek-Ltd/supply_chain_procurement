"""Action handler seed for supplier_qualification:approve."""
...
ACTION_ID = "approve"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'qualified', 'rejected'], 'transitions_to': None}
