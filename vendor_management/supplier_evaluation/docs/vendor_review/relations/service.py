"""Relation service seed for vendor_review."""
...
RELATED_DOCS = [{'doc_id': 'supplier_profile', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'supplier_qualification', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'vendor_contract', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'supplier identity'}, {'description': 'contract/SLA context from linked docs'}]
